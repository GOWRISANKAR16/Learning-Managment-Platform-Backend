...
export function isDbConnectionError(err: unknown): boolean {
  ...
  if (code === "P2010" || code === "P2011") return true; // column not found / invalid data
  if (msg.includes("column") && (msg.includes("does not exist") || msg.includes("unknown"))) return true;
  if (msg.includes("incorrect integer value") || msg.includes("incorrect string value")) return true;
  return false;
}
