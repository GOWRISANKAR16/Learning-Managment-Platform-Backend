...
exports.getFlattenedVideos = getFlattenedVideos;
exports.getPrevNextVideoId = getPrevNextVideoId;
exports.isVideoLocked = isVideoLocked;
/**
 * Returns flattened list of videos in global order for a subject (course).
 */
function getFlattenedVideos(sections) {
 ...
 */
function getPrevNextVideoId(flatVideos, videoId) {
